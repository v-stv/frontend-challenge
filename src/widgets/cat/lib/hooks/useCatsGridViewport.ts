...
import { CAT_MIN_CARD_HEIGHT, CAT_ROWS_PER_VIEWPORT } from '@/widgets/cat/config/constants'

export const useCatsGridViewport = () => {
    ...
    const measureViewport = () => {
        ...
        const availableHeight = Math.max(
            ...
            CAT_MIN_CARD_HEIGHT * CAT_ROWS_PER_VIEWPORT,
        )
